...
class GroupsListTest {
    ...
    public void testIfGroupWasCreated() {
        ...
        Person person1 = new Person("John", 2015, 5, 10, new Address("London"),new Address("Rua B","Feira","4520-233"));
    ...
    public void testIfGroupWasNotCreated() {
        //Arrange
        GroupsList groupsList = new GroupsList();
        Person person1 = new Person("Francis", 2012, 4, 23, new Address("Dublin"),new Address("Rua B","Feira","4520-233"));
    ...
    public void testIfGroupWasAlreadyInList() {
        //Arrange
        GroupsList groupsList = new GroupsList();
        Person person1 = new Person("Amy", 2002, 5, 20, new Address("Boston"),new Address("Rua B","Gaia","4520-233"));
    ...
    public void createGroupWithSameDescriptionAndDifferentMembers() {
        ...
        GroupsList groupsList = new GroupsList();
        Person person1 = new Person("Amy", 2002, 5, 20, new Address("Boston"),new Address("Rua B","Gaia","4520-233"));
        Person person2 = new Person("Marshall", 2002, 5, 20, new Address("Boston"),new Address("Rua B","Gaia","4520-233"));
    ...
    public void ifGroupListIsOnlyFamilies_SuccessCase() {
        ...
        Person manuelaMOM = new Person("Manuela", 1990, 10, 10, new Address("Miragaia"),new Address("Rua B","Gaia","4520-233"));
        Person carlosDAD = new Person("Carlos", 1990, 10, 10, new Address("Porto"),new Address("Rua B","Gaia","4520-233"));
        Person oscar = new Person("Oscar", 1990, 10, 10, new Address("Espinho"),new Address("Rua B","Gaia","4520-233"), manuelaMOM, carlosDAD);
        Person marta = new Person("Marta", 1990, 10, 10, new Address("Paranhos"),new Address("Rua B","Gaia","4520-233"), manuelaMOM, carlosDAD);
        Person joao = new Person("Joao", 1990, 10, 10, new Address("Matosinhos"),new Address("Rua B","Gaia","4520-233"), manuelaMOM, carlosDAD);
        ...
        Person homer = new Person("Homer", 1990, 10, 10, new Address("Springfield"),new Address("Rua B","Porto","4520-233"));
        Person marge = new Person("Marge", 1990, 10, 10, new Address("Springfield"),new Address("Rua B","Porto","4520-233"));
        Person bart = new Person("Bart", 1990, 10, 10, new Address("Springfield"),new Address("Rua B","Porto","4520-233"), marge, homer);
        Person lisa = new Person("Lisa", 1990, 10, 10, new Address("Springfield"), new Address("Rua B","Porto","4520-233"),marge, homer);
        Person maggie = new Person("Maggie", 1990, 10, 10, new Address("Springfield"),new Address("Rua B","Porto","4520-233"), marge, homer);
        ...
        Person joaoDAD = new Person("Joao", 1990, 10, 10, new Address("Miragaia"),new Address("Rua B","Gaia","4520-233"));
        Person diana = new Person("Diana", 1990, 10, 10, new Address("Porto"),new Address("Rua B","Gaia","4520-233"), null, joaoDAD);
        Person elsa = new Person("Elsa", 1990, 10, 10, new Address("Matosinhos"),new Address("Rua B","Gaia","4520-233"), null, joaoDAD);
        Person ines = new Person("Ines", 1990, 10, 10, new Address("Paranhos"),new Address("Rua B","Gaia","4520-233" ),null, joaoDAD);
        ...
        Person martaR = new Person("Marta Ribeiro", 1990, 10, 10, new Address("Miragaia"),new Address("Rua B","Gaia","4520-233"));
        Person martaC = new Person("Marta Cardoso", 1990, 10, 10, new Address("Matosinhos"),new Address("Rua B","Gaia","4520-233"));
        Person martaP = new Person("Marta Pinheiro", 1990, 10, 10, new Address("Porto"),new Address("Rua B","Gaia","4520-233"));
        ...
        Person bojack = new Person("Bojack", 1990, 10, 10, new Address("Porto"),new Address("Rua B","Porto","4520-233"));
        Person carolyn = new Person("Princess Carolyn", 1990, 10, 10, new Address("Lisboa"),new Address("Rua B","Porto","4520-233"));
        Person todd = new Person("Todd Chavez", 1990, 10, 10, new Address("Matosinhos"),new Address("Rua B","Porto","4520-233"));
        Person diane = new Person("Diane Nguyen", 1990, 10, 10, new Address("Espinho"),new Address("Rua B","Porto","4520-233"));
