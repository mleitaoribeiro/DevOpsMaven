...
class US006CreatePersonAccountServiceTest {
    ...
    static void universeSetUp() {
        service = new US006CreatePersonAccountService();
    ...
    void testIfPersonAccountAreCreated() {
        ...
        //Act
        boolean accountCreated =service.createPersonAccount(personRepo, accountRepo, onePersonID, new Denomination("Revolut"),
    ...
    void testIfPersonAccountIsCreated() {
        ...
        //Act
        boolean accountsCreated = service.createPersonAccount(personRepo, accountRepo, onePersonID, new Denomination("Revolut"),
                new Description("OnlineShopping"))
                && service.createPersonAccount(personRepo, accountRepo, onePersonID, new Denomination("MbWay"),
                new Description("For sharing expenses"))
                && service.createPersonAccount(personRepo, accountRepo, onePersonID, new Denomination("CXG"),
    ...
    void testIfAccountIsCreateNonExistingID() {
        ...
        //Act
        try {
            service.createPersonAccount(personRepo, accountRepo, newPersonID, new Denomination("Revolut"),
                    new Description("OnlineShopping"));
        }
    ...
    void testIfAccountIsCreateNullID() {
        ...
        //Act
        try {
            service.createPersonAccount(personRepo, accountRepo, nullID, new Denomination("Revolut"),
                    new Description("Online Shopping"));
        }
    ...
    void testIfAccountIsCreateEmptyID() {
        ...
        //Act
        try {
            service.createPersonAccount(personRepo, accountRepo, new PersonID(new Email("")), new Denomination("Revolut"),
                    new Description("Online Shopping"));
        }
    ...
    void testIfAccountIsCreateNullDenomination() {
        ...
        //Act
        try {
            service.createPersonAccount(personRepo, accountRepo, onePersonID, null,
                    new Description("Online Shopping"));
        }
        //Assert
        catch (IllegalArgumentException invalid) {
