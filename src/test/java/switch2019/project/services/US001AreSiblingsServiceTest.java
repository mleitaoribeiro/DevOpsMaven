...
class US001AreSiblingsServiceTest {
    ...
    void AreSiblingsSameMotherFatherAndList() {
        ...
        //Act
        boolean siblings = service.AreSiblings(personRepo, antonioEmail, manuelEmail);
    ...
    void AreSiblingsSameMother() {
        ...
        //Act
        boolean siblings = service.AreSiblings(personRepo, antonioEmail, robertoEmail);
    ...
    void AreSiblingsSameFather() {
        ...
        //Act
        boolean siblings = service.AreSiblings(personRepo, antonioEmail, amaliaEmail);
    ...
    void AreSiblingsInTheSiblingsList() {
        ...
        //Act
        boolean siblings = service.AreSiblings(personRepo, joseEmail, rafaelEmail);
    ...
    void AreSiblingsFalse() {
        ...
        //Act
        boolean siblings = service.AreSiblings(personRepo, joseEmail, robertoEmail);
        boolean siblings2 = service.AreSiblings(personRepo, mariaEmail, amaliaEmail);
    ...
    void AreSiblingsInvalidEmail() {
        ...
        //Act
        try {
            service.AreSiblings(personRepo, joseEmail, robertoEmail);
        }
